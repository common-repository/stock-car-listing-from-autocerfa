                    ...
                    <div class="row">
                        ...
                        if (!empty($leads)):
                            foreach ($leads as $lead) :
                                    ...
                                    <div class="autocerfa-car-item">
                                        <div class="autocerfa-thumb-content">
                                            ...
                                            <div class="autocerfa-thumb-inner">
                                                <a href="<?= esc_url($url) ?>"><img
                                                    src="<?= esc_attr($image_url) ?>"
                                                    alt="<?= esc_attr($lead->title) ?>"></a>
                                                </div>
                                            </div>
                                            <div class="autocerfa-down-content autocerfa-down-content-grid">
                                                <a href="<?= esc_url($url) ?>"><h4><?= esc_attr($lead->title) ?></h4>
                                                </a>
                                ...
                                ?>
                                <div class="col-md-12">
                                    <p class='no-result-message'><?php _e('Sorry, we don’t have any cars according your criteria, try something else',
